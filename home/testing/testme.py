...
def unzipCompareCompile():
    ...
    osdir = '/home/ubuntu/workspace/testing'
...
def Select(tableData, hour, sort):
    tableData.pop(0)
...
def main():
    ...
    finalData = [['Location', 'Price'], ['CADICKS_804V', 13.69], ['ADICKS__138B', 13.69], ['ADICKS__8030', 13.69], ['ADK_V_C', 13.69], ['CADICKS_804O', 13.69], ['CADICKS_804N', 13.69], ['ADICKS__345A', 13.7], ['ADICKS_345C', 13.7], ['ADICKS_138N', 13.69]]
   # finalData = Select(tableData, hour, sort)
    print finalData
main()
